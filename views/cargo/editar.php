...
<script type="text/javascript">
    function editarCargo() {        
        if(validarCampos()){
            ...
            $.ajax({
                data: datos,
                url: '/Jomar/users_control/controller/CargoController.php?action=guardarEdit',
                type: 'post',
...
<body>
    ...
    <form name="formEditar" id="formEditar" method="POST">
        <div class='container shadow p-5 mb-1 mt-n1 bg-white rounded' style= "width: 800px">            
            ...
            <input type="hidden" name="id" value="<?php echo ($cargo[0]["id_cargo"]); ?>">
            <div class="form-group row justify-content-center"> 
                <label class=" col-form-label" style="margin-right: 0px" for="cargo">Cargo:</label>
                <div class="col-5">
                    <input type="text" class="form-control" autocomplete="off" name="cargo" id="cargo" value="<?php echo ($cargo[0]["cargo"]); ?>" />
                </div>
            </div>
            <br>                            
            <div class="form-group row justify-content-center">
                <div class="justify-content-center">                
                    <button class="btn btn-primary mr-4 btn-md" style="width: 150px" id="submit" onclick="editarCargo()" type="button">Editar</button>            
...
<script type="text/javascript">        
    function validarCampos(){
        ...
        var antCargo = "<?php echo $cargo[0]["cargo"] ?>";        
        ...
        if(cargo == ""){
            ...
            formOk = false;
        }else if(cargo.toLowerCase() != antCargo.toLowerCase()){
