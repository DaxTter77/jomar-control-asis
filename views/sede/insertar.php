...
<script type="text/javascript">
    function guardarSede() {        
        if(validarCampos()){
            ...
            $.ajax({
                data: datos,
                url: '/Jomar/users_control/controller/SedeController.php?action=guardarInser',
                type: 'post',
    ...
    <form name="formInsertar" id="formInsertar" method="POST">
        <div class='container shadow p-5 mb-1 mt-n1 bg-white rounded' style= "width: 800px">            
            ...
            <div class="form-group row justify-content-center"> 
                ...
                <div class="col-5">
                    <input type="text" class="form-control" autocomplete="off" name="sede" id="sede"/>
                </div>
            </div>                                         
            <br>            
            <div class="form-group row justify-content-center">
                <div class="justify-content-center">                
                    <button class="btn btn-primary mr-4 btn-md" style="width: 150px" id="submit" onclick="guardarSede()" type="button">Guardar</button>            
...
<script type="text/javascript">        
    function validarCampos(){
        var sede = document.forms["formInsertar"]["sede"].value;                    
