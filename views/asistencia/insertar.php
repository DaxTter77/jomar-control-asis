...
<head>
    ...
    <title>Ingresar Asistencia</title>
</head>
<script type="text/javascript">
    function guardarAsistencia() {        
        if(validarCampos()){
            ...
            $.ajax({
                data: datos,
                url: '/Jomar/users_control/controller/AsistenciaController.php?action=guardarInser',
                type: 'post',
    ...
    <form name="formInsertar" id="formInsertar" method="POST">
        <div class='container shadow p-5 mb-1 mt-n1 bg-white rounded' style= "width: 800px">            
            ...
            <div class="form-group row justify-content-center"> 
                ...
                <div class="col-5">
                    <input type="text" class="form-control" autocomplete="off" name="asistencia" id="asistencia"/>
                </div>
            </div>
            <div class="form-group row justify-content-center"> 
                <label class=" col-form-label" style="margin-right: 35px" for="sigla">Sigla:</label>
                <div class="col-5 ">
                    <input type="text" style="text-transform: uppercase;" onkeyup="this.value = this.value.toUpperCase();" class=" form-control" autocomplete="off" name="sigla" id="sigla"/>
                </div>
            </div>                                   
            <br>            
            <div class="form-group row justify-content-center">
                <div class="justify-content-center">                
                    <button class="btn btn-primary mr-4 btn-md" style="width: 150px" id="submit" onclick="guardarAsistencia()" type="button">Guardar</button>            
...
<script type="text/javascript">        
    function validarCampos(){
        var asistencia = document.forms["formInsertar"]["asistencia"].value;
        var sigla = document.forms["formInsertar"]["sigla"].value;                
